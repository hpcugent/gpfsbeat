...
replace (
	...
	//github.com/Shopify/sarama => github.com/Shopify/sarama v1.19.1-0.20200629123429-0e7b69039eec
	...
	github.com/elastic/beats/v7 => github.com/itkovian/beats/v7 v7.0.0-20201102221425-8ac346499b35
